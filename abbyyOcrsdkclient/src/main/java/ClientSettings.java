...
public class ClientSettings {
	...
	public static final String APPLICATION_ID = "test54321"; /*real, mar 2015, Albert*/
	// Password should be sent to your e-mail after application was created
	public static final String PASSWORD = "vob3MppjOfIQrs5aBpmvfbGP"; /*real, mar 2015, Albert*/
